...
-- vim.keymap.set('i', '<leader>n', '<Esc>:Neotree toggle<CR>')
-- vim.keymap.set('n', '<leader>n', ':Neotree toggle<CR>')
vim.keymap.set('n', '<leader>nf', ':Neotree float<CR>')
vim.keymap.set('n', '<leader>nl', ':Neotree left<CR>')
vim.keymap.set('n', '<leader>nr', ':Neotree right<CR>')

vim.keymap.set('i', '<leader>nf', ':Neotree float<CR>')
vim.keymap.set('i', '<leader>nl', ':Neotree left<CR>')
